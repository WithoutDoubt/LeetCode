...
from model.NaiveRTransformer import RTransformer 
# from model.RTransformer import RTransformer 
# from rezero.transformer import RZTXEncoderLayer
class RT(nn.Module):
    def __init__(self, input_size=161, d_model=320, output_size=161, h=4, rnn_type="GRU", ksize=3, n=1, n_level=2, dropout=0.1, emb_dropout=0.1):
